    ...
    <>
      ...
      {isloading ? (
        ...
        <View
          ...
          <TouchableOpacity onPress={() => navigate.navigate('details')}>
            <Info name="person" color={color.primary} size={30} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigate.navigate('admitCard')}>
                ...
                <View
                  style={{
                    ...
                    <Text style={{
                      ...
                      marginBottom: 50,
                      textAlign: 'center',
                    }}>You Have Already Applied For Courses</Text>
                  ...
                  }} color={color.primary}>Go Back</Button>
                </View>
              </View>
            </>
          ) : (
